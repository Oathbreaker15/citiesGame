import { ICity, IModel } from "./interfaces/modelInterfaces";
import { IGame, IGameState } from "../game-service/interfaces/gameInterfaces";
...
export class Game implements IGame {
    ...
    public generateWarning(error: string): string {
        throw error;
    }
